const common = {
  ...
  categoryList: {
    ...
    footer: {
      tagline: "أكثر من 136 أداة مساعدة مجانية عبر الإنترنت — لا يلزم حساب، لا توجد إعلانات على الأدوات، لا يتم تتبع مدخلاتك.",
      newTools: "تضاف أدوات جديدة كل أسبوع",
      newToolsDesc: "تصفح جميع الفئات وقم بوضع إشارة مرجعية على مفضلاتك — لا يلزم بريد إلكتروني.",
      browseAll: "تصفح جميع الأدوات الـ 136",
      categories: "الفئات",
      popularTools: "الأدوات الشائعة",
      company: "الشركة",
      byTheNumbers: "بالأرقام",
      freeTools: "أدوات مجانية",
      signupsRequired: "التسجيلات المطلوبة",
      adsOnTools: "إعلانات على الأدوات",
      browserBased: "يعتمد على المتصفح",
      ...
      catNumbers: "الأرقام",
      catTime: "الوقت والتاريخ",
      catGenerators: "المولدات",
      catDev: "أدوات المطورين",
      catWriting: "الكتابة والذكاء الاصطناعي",
      catColors: "الألوان والتصميم",
      toolWordCounter: "عداد الكلمات",
      toolAgeCalculator: "حاسبة العمر",
      toolPasswordGenerator: "مولد كلمات المرور",
      toolJsonFormatter: "منسق JSON",
      toolUnitConverter: "محول الوحدات",
      toolPercentageCalc: "حاسبة النسبة المئوية",
      toolQrCodeReader: "قارئ رمز QR",
      toolColorConverter: "محول الألوان",
      companyAbout: "حول",
      companyPrivacy: "سياسة الخصوصية",
      companyTerms: "شروط الخدمة",
    },
} as const;
