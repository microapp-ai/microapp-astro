...
const common = {
  ...
  categoryList: {
    ...
    footer: {
      tagline: "Más de 136 herramientas de utilidad en línea gratuitas: no se necesita cuenta, no hay anuncios en las herramientas, no hay seguimiento de sus entradas.",
      newTools: "Nuevas herramientas añadidas cada semana",
      newToolsDesc: "Explore todas las categorías y marque sus favoritas, no se requiere correo electrónico.",
      browseAll: "Explorar las 136 herramientas",
      categories: "Categorías",
      popularTools: "Herramientas populares",
      company: "Compañía",
      byTheNumbers: "Por los números",
      freeTools: "Herramientas gratuitas",
      signupsRequired: "Registros requeridos",
      adsOnTools: "Anuncios en herramientas",
      ...
      catNumbers: "Números",
      catTime: "Hora y fecha",
      catGenerators: "Generadores",
      catDev: "Herramientas para desarrolladores",
      catWriting: "Escritura e IA",
      catColors: "Colores y diseño",
      toolWordCounter: "Contador de palabras",
      toolAgeCalculator: "Calculadora de edad",
      toolPasswordGenerator: "Generador de contraseñas",
      toolJsonFormatter: "Formateador JSON",
      toolUnitConverter: "Convertidor de unidades",
      toolPercentageCalc: "Calculadora de porcentaje",
      toolQrCodeReader: "Lector de códigos QR",
      toolColorConverter: "Convertidor de color",
      companyAbout: "Acerca de",
      companyPrivacy: "Política de privacidad",
      companyTerms: "Términos de servicio",
    },
} as const;
