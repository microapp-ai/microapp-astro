const common = {
  ...
  categoryList: {
    ...
    footer: {
      tagline: "Über 136 kostenlose Online-Dienstprogramme – kein Konto erforderlich, keine Werbung für Tools, keine Verfolgung Ihrer Eingaben.",
      newTools: "Jede Woche neue Tools",
      newToolsDesc: "Durchsuchen Sie alle Kategorien und setzen Sie ein Lesezeichen für Ihre Favoriten – keine E-Mail erforderlich.",
      browseAll: "Alle 136 Tools durchsuchen",
      categories: "Kategorien",
      popularTools: "Beliebte Tools",
      company: "Unternehmen",
      byTheNumbers: "Nach Zahlen",
      freeTools: "Kostenlose Tools",
      signupsRequired: "Anmeldungen erforderlich",
      adsOnTools: "Werbung für Tools",
      ...
      catNumbers: "Zahlen",
      catTime: "Zeit & Datum",
      catGenerators: "Generatoren",
      catDev: "Entwickler-Tools",
      catWriting: "Schreiben & KI",
      catColors: "Farben & Design",
      toolWordCounter: "Wortzähler",
      toolAgeCalculator: "Altersrechner",
      toolPasswordGenerator: "Passwort-Generator",
      toolJsonFormatter: "JSON Formatter",
      toolUnitConverter: "Einheitenumrechner",
      toolPercentageCalc: "Prozentrechner",
      toolQrCodeReader: "QR Code Reader",
      toolColorConverter: "Farbkonverter",
      companyAbout: "Über",
      companyPrivacy: "Datenschutzrichtlinie",
